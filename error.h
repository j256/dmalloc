 ...
 *
 * $Id: error.h,v 1.30 1997/03/21 17:21:30 gray Exp $
 */
 ...
 */
extern	char	*_dmalloc_ptimeval(const struct timeval * timevalp,
				   const char elapsed);
#endif
 ...
 * print the time into local buffer which is returned
 */
extern	char	*_dmalloc_ptime(const long * timep, const char elapsed);
#endif
