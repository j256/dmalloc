 ...
 *
 * $Id: heap.h,v 1.41 2003/05/13 14:54:47 gray Exp $
 */
...
#define IS_IN_HEAP(pnt)		\
  ((char *)(pnt) >= (char *)_dm_heap_base \
   && (char *)(pnt) < (char *)_dm_heap_last)
...
extern
void	*_dm_heap_base;			/* base of our heap */

extern
void	*_dm_heap_last;			/* end of our heap */
