 ...
 *
 * $Id: heap.h,v 1.30 1997/01/16 15:25:07 gray Exp $
 */
...
extern	void		*_heap_base;	/* base of our heap */

extern	void		*_heap_last;	/* end of our heap */

/*
 * initialize heap pointers.  returns [NO]ERROR
 */
extern	int	_heap_startup(void);
 ...
 */
extern	void	*_heap_alloc(const unsigned int size, void ** externp,
			     int * externcp);
